...
public class RepoUpdater {
    ...
    private void saveToDb(App app, List<Apk> packages) {
        appsToSave.add(app);
    ...
    private void flushApksToDbInBatch() {
    ...
    private void flushAppsToDbInBatch() {
    ...
    void processDownloadedFile(File downloadedFile) throws UpdateException {
